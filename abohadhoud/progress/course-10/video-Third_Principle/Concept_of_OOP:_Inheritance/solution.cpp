...
public:
  // we put the default constructor here temperorly becasue inheritance will use
  // it, in the comming lectures we will solve the prametarized constructor with
  // inheritance.
  clsPerson() {}
...

{
  ...
  // Calling the print will not print anything from derived class, only base
  // class therfore the print method will not serve me here, this is a problem
  // will be solved in the next lecture.
  Employee1.Print();
