...
short IsEndOfWeek(stDate Date) { return DayOfWeekOrder(Date) == 6; }
...
short DaysUntilTheEndOfWeek(stDate Date) { return 6 - DayOfWeekOrder(Date); }
...
int main() {
  ...
  //---------------------
  cout << "\n\nDays until end of week : " << DaysUntilTheEndOfWeek(Date1)
       << " Day(s).";
  //---------------------
  cout << "\nDays until end of month : " << DaysUntilTheEndOfMonth(Date1)
       << " Day(s).";
  //---------------------
  cout << "\nDays until end of year : " << DaysUntilTheEndOfYear(Date1)
       << " Day(s).";
  system("pause>0");
  return 0;
}