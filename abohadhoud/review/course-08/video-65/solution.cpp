...
Write a program to read Date and
        write a Function to format that Date Please Enter Date dd /
    mm / yyyy
    ? 26 / 8 / 2023 vector<string> SplitString(string S1, string Delim) {
...
string FormateDate(stDate Date, string DateFormat = "dd/mm/yyyy") {
  ...
  FormattedDateString =
      ReplaceWordInString(DateFormat, "dd", to_string(Date.Day));
  FormattedDateString =
