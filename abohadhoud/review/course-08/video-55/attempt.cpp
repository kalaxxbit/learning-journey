...
int main() {
  ...
  Date = ReadDate();
   ...
   VacationDays =ReadShortNumber("Enter Vacation Days: ");
    
   ReturnDate= VacationReturnDate(Date,VacationDays);
   
    cout<<"Return Date Is: "<<DayNameInOrder(DayOrderInDate(ReturnDate))<<" , "<<ConvertDateToStringDate(ReturnDate)<<endl;
