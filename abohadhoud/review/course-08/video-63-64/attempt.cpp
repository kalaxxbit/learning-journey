...
{
	return (Date.Month <= 12) && (Date.Month >= 1) && (Date.Day >= 1) && (Date.Day <= NumberOfDaysInAMonth(Date.Month, Date.Year));
}
...
int main()
{
	...
	cout<<"You Entered: "<<ConvertDateToStringDate(StringToDate(Date))<<endl;
	return 0;
}