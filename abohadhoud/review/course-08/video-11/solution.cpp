...
© Copyright 2022 Problem #11 /
    4 Solution Using C++ sDate GetDateFromDayOrderInYear(short DateOrderInYear,
                                                         short Year) {
  sDate Date;
...
ProgrammingAdvices.com
© Copyright 2022 Problem #11 / 4 Solution Using C++ short ReadYear() {
  short Year;
  cout << "\nPlease enter a Year? ";
  cin >> Year;
  return Year;
